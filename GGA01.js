if (document.location.origin != "https://lh3.googleusercontent.com") {
  ...
  if ((e_div == null) && (e_target != null)) {
    ...
    e_div.innerHTML = `<input id="txt_clip" type="text" style="width: 320px;height: 100px">&emsp;<button id="btn_GetName">get name</button>&emsp;<button id="btn_clear">clear</button><br/><div id="img_dsp"></div>`;
            ...
            if ((sTmp == undefined) || (sTmp == null)) {
              ...
              for (var i=0; i<aTmp.length; i++) {
                if (aTmp[i].substr(0, 9) == "filename=") {
                  ...
                  if (aTmp1.length == 2) {
                    img_dsp.innerHTML = '<img id="img_gga" src="' + url + '" onload="fnGetImageSize()"><br/><input id="txt_url" type="text" style="width: 320px;" value=""><br/><input id="txt_name" type="text" style="width: 320px;" value="' + aTmp1[1] + '">';
                  }
                }
              }
            }
